        ...
        <div class="ltn__shop-options">
            <ul class="justify-content-start">
                ...
                $query = mysqli_query($con, "
                    ...
                    FROM tblposts
                    WHERE Area IS NOT NULL AND Area != '' AND CategoryId = 9
                ");
                ...
                $query = mysqli_query($con, "
                    ...
                    FROM tblposts
                    WHERE Location IS NOT NULL AND Location != '' AND CategoryId = 9
                ");
            ...
            <div class="ltn__product-tab-content-inner ltn__product-grid-view">
                <div class="row">
                    ...
                    $query = "SELECT 
                              ...
                              WHERE 
                                tblposts.CategoryId = 9 AND tblposts.Is_Active = 1";
